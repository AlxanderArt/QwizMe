    ...
    <div className="max-w-2xl mx-auto">
          ...
          return (
            <div key={question.id} className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              {question.explanation && (
                <p className="mt-3 ml-7 text-sm text-gray-500 bg-gray-50 rounded-lg px-3 py-2">
                  {question.explanation}
                </p>
              )}
            </div>
      ...
      <div className="flex gap-3 mt-8">
        <button
          ...
          className="flex items-center gap-2 flex-1 justify-center py-2.5 bg-white text-gray-700 font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors cursor-pointer"
        >
        ...
        <Link
          to="/dashboard"
          className="flex items-center gap-2 flex-1 justify-center py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors"
        >
